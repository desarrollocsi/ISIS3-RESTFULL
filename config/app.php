...
return [
    ...
    */
    ...
    'providers' => [
        ...
        Laravel\Passport\PassportServiceProvider::class, // JLT:20201026

        Spatie\Activitylog\ActivitylogServiceProvider::class, // JLT:20201030 : Crear el modelo Log.
